...
- **Stage 2 — Association analysis:** causal forest estimation, and prescription generation.
...
python stage2/stage2_hierarchical_cf.py
python stage2_cf_prescription_generation.py   # run causal prescription generation
```
...
With the metadata provided in the paper, you can find and request the datasets.
