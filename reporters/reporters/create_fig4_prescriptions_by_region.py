...
TREATMENT_ORDER = rcfg.ALL_TREATMENTS  # canonical sorted

REGION_ORDER = rcfg.REGION_ORDER
REGION_COLORS = rcfg.REGION_COLORS
...
def main() -> None:
    ...
    if args.out_dir:
        ...
        out_dir = rcfg.ensure_reports_dir(stage2_root)
