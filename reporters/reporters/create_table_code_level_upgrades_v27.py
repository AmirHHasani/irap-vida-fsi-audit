...
from stage2_treatment_codebook import get_spec  # noqa: E402


CODEBOOK_LABELS_CSV = rcfg.CODEBOOK_CSV
...
def resolve_stage2_root(*, stage2_output_dir: str | None, run_id: str | None) -> Path:
    return rcfg.resolve_stage2_root(
        stage2_output_dir=stage2_output_dir, run_id=run_id
    )
...
def main() -> None:
    ...
    if args.out_csv:
        ...
        reports_dir = rcfg.ensure_reports_dir(stage2_root)
